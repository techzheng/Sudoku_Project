...
def grid_setup(screen, grid, text_font):
    for i in range(0, 10):
        if i % 3 == 0:
            pygame.draw.line(screen, (0,0,0), (60*i + 60, 60), (60*i + 60, 600), 5)
            pygame.draw.line(screen, (0,0,0), (60, 60*i + 60), (600, 60*i + 60), 5)
        else:
            pygame.draw.line(screen, (0,0,0), (60*i + 60, 60), (60*i + 60, 600), 2)
            pygame.draw.line(screen, (0,0,0), (60, 60*i + 60), (600, 60*i + 60), 2)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if 1 <= (event.key - 48) <= 9: # check input for 1-9
                        pygame.draw.rect(screen, (230, 230, 230), (position[0]*60 + 5, position[1]*60 + 5, 60 - 8, 60 - 8))
                        value = text_font.render(str(event.key - 48), True, (0, 0, 255))
